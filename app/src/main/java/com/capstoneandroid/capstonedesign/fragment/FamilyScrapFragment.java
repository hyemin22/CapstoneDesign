...
public class FamilyScrapFragment extends Fragment {

    private TextView restaurantTextView, travelTextView, experienceTextView;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_family_scrap, container, false);
        ...
        setTextViewClickListener(experienceTextView);
    ...
    private void resetAllTextViewColors() {
        ...
        experienceTextView.setTextColor(Color.parseColor("#B4B4B4")); // 회색
    }
}